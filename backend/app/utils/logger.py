...
Provides unified logging with output to both console and files
"""
...
def _ensure_utf8_stdout():
    ...
    Fixes garbled CJK text on Windows console
    """
...
def setup_logger(name: str = 'mirofish', level: int = logging.DEBUG) -> logging.Logger:
    ...
    # Ensure UTF-8 encoding on Windows to avoid garbled CJK text
    _ensure_utf8_stdout()
