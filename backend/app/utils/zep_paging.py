...
This module wraps auto-paging logic (with per-page retry),
...
def fetch_all_nodes(
    ...
    """Paginated fetch of graph nodes, returns up to max_items (default 2000). Each page request has built-in retry."""
    all_nodes: list[Any] = []
...
def fetch_all_edges(
    ...
    """Paginated fetch of all graph edges, returns the complete list. Each page request has built-in retry."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
