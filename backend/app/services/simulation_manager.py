...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        Steps:
        1. Read and filter entities from the Zep graph
        2. Generate OASIS Agent profiles for each entity (optional LLM enrichment, parallel)
        3. Use LLM to generate simulation config parameters (time, activity, frequency, etc.)
        ...
        try:
            ...
            if state.enable_twitter:
                # Twitter uses CSV format as required by OASIS
                generator.save_profiles(
                    profiles=profiles,
            ...
            # when starting a simulation, simulation_runner runs scripts from scripts/
