...
def chat_with_report_agent():
    ...
    Request (JSON):
        {
            "simulation_id": "sim_xxxx",            // Required, simulation ID
            "message": "Explain the opinion trend",  // Required, user message
...
def get_agent_log(report_id: str):
    ...
    Get each step's action during report generation in real-time, including:
...
def get_console_log(report_id: str):
    ...
    Get console output (INFO, WARNING, etc.) from report generation in real-time.
