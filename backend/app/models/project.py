...
Persists project state on the server to avoid passing large data between frontend API calls
"""
...
class Project:
    ...
    # Ontology info (populated after API 1)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None

    # Graph info (populated after API 2)
...
class ProjectManager:
    """Project manager - handles persistent storage and retrieval"""
