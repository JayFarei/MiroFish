      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            ...
            <p class=”slogan-text”>
              Rehearse the future in agent swarms, let decisions prevail after a thousand battles<span class=”blinking-cursor”>_</span>
            </p>
          </div>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity-relation extraction & persona generation & agent simulation parameters injection</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse prediction requirements & dynamic temporal memory update</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction requirement in natural language (e.g., What public opinion trends would emerge if a university reversed a disciplinary decision?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
